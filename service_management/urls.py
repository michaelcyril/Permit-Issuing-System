...
urlpatterns = [
    ...
    path(
        ...
        ChangePermitStatusView.as_view(),
        name="request_get_permit",
    ),
    path(
        "change-payment-status",
        ChangePermitPaymentStatusView.as_view(),
        name="request_get_permit",
    ),
    # path('change', views.ChangePermitPaymentStatusView)
    path("get-all-permit", GetPermitView.as_view(), name="get_all_permit"),
    path(
        "get-permit-information",
        GetPermitInformation.as_view(),
        name="get_permit_information",
    ),
]
